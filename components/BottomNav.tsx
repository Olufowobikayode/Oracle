...
const BottomNav: React.FC = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-stone-900/80 backdrop-blur-sm border-t border-amber-900/50 flex justify-around items-center z-40">
      <NavItem 
        to="/app/dashboard"
        label="Dashboard"
      ...
      />
       <NavItem 
        to="/app/keywords"
        label="Keywords"
        icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7h3a5 5 0 015 5 5 5 0 01-5 5h-3m-6 0H6a5 5 0 01-5-5 5 5 0 015-5h3m-3 0h6"></path></svg>}
      />
      <NavItem 
        to="/app/qna"
        label="Q&A"
